...
class PieceTest(unittest.TestCase):
    ...
    def test_colour_must_be_0_or_1(self):
        Piece(colour=0)
        Piece(colour=1)
    ...
    def test_equal_pieces_are_equal(self):
        piece_1 = Piece(colour=0)
        test_piece_1 = Piece(colour=0)
        piece_2 = Piece(colour=1)
        test_piece_2 = Piece(colour=1)
        piece_3 = Piece(colour=0)
        piece_3.promote()
        test_piece_3 = Piece(colour=0)
    ...
    def test_not_equal_pieces_are_not_equal(self):
        piece_1 = Piece(colour=0)
        test_piece_1 = Piece(colour=1)
        piece_2 = Piece(colour=0)
        piece_2.promote()
        test_piece_2 = Piece(colour=0)
        piece_3 = Piece(colour=0)
        test_piece_3 = Piece(colour=1)
        piece_3.promote()
        test_piece_3.promote()
